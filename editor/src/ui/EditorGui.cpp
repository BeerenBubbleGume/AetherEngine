...
namespace AetherEditor::ui {
    ...
    auto EditorGui::init(const engine::core::EngineContext &ctx) -> std::expected<void, AetherEditor::core::EditorError> {
        IMGUI_CHECKVERSION();
        ImGui::CreateContext();
    ...
    auto EditorGui::endFrame(engine::graphics::RenderExtent backbufferExtent) -> void {
