...
namespace AetherEditor::ui {
    ...
    public:
        ...
        auto init(const engine::core::EngineContext& ctx) -> std::expected<void, AetherEditor::core::EditorError>;
        auto onEvent(const SDL_Event& event) -> void;
        auto beginFrame() -> void;
        auto endFrame(engine::graphics::RenderExtent backbufferExtent) -> void;
        auto shutdown() -> void;
